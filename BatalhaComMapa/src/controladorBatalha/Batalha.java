...
public class Batalha extends ControladorBatalha{
	...
	public void batalha(){
		...
		if(b.pegaNome()!= null)
			...
			System.out.println("Um " + b.pokemonAtual().pegaNome() + " selvagem apareceu para " + a.pegaNome() + "!");
		System.out.println("");
		a.imprimirInfo();
		b.imprimirInfo();
		System.out.println("");
		...
		if(b.pegaNome() != null){
			...
			System.out.println("*" + b.pokemonAtual().pegaNome() + " se prepara para atacar*");
		}	
		System.out.println("");
		while (a.podeBatalhar() && b.podeBatalhar()){
		    if ((Ea = (EventosBatalha) Sa.pegarProx()) != null && (Eb = (EventosBatalha) Sb.pegarProx()) != null) {
		...
		if (a.podeBatalhar()){
			...
			if(b.pegaNome() != null)
				...
				System.out.println("O pokemon selvagem " + b.pokemonAtual().pegaNome() + " venceu a batalha.");
		}
		else {
	...
	public EventosBatalha retornaOrdem (EventosBatalha Ea, EventosBatalha Eb){
	...
	private class Atacar extends EventosBatalha{
		...
		public void acao(Treinador player, Treinador sofreu) {
			...
			if (!(sofreu.pokemonAtual().podeBatalhar())){
				...
				if(sofreu.pegaNome() != null){
					...
					System.out.println(sofreu.pokemonAtual().pegaNome() + " desmaiou.");
				}
			}
		}
	...
	private class UsarItem extends EventosBatalha{
	...
	private class TrocarPokemon extends EventosBatalha{
	...
	private class Fugir extends EventosBatalha{
	...
	class Reiniciar1 extends EventosBatalha{
	...
	private class Reiniciar2 extends EventosBatalha{
